...
* **asset**: A network, named by a short label and identified by a
  **chain identifier**. See below — the label is for humans and the
  identifier is what implementations compare.
...
Every asset reference is a pair — a **label** and a **chain identifier**:

```jsonc
["sell", "btc", "0014868a826ddd4e7017b9a41ccb6f82ec08e5d511ee"]
//        ^label  ^chain identifier
```

The label is human-readable, carries no authority, and MUST NOT be used
to decide anything. The chain identifier is what an implementation
compares, and an implementation MUST reject any message whose identifier
it does not recognise, **even if the label is familiar**.
...
> regardless of which signet issued it. **A label and a prefix are both
> insufficient**, and the failure they produce is an invoice paid on the
> wrong chain — caught, if at all, by a human reading an amount.
...
{
  "type": "accept",
  "sell_chain": "0014868a826ddd4e7017b9a41ccb6f82ec08e5d511ee",
  "buy_chain":  "0014eb5dbbf606bccfb5333530ead2e47af83ce3a668",
