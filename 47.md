...
```jsonc
{
    ...
    "content": "pay_invoice get_balance make_invoice lookup_invoice list_transactions get_info pay_offer make_offer lookup_offer list_offers disable_offer notifications",
    // ...
}
```
...
```jsonc
{
    ...
    "result": {
            ...
            "methods": ["pay_invoice", "get_balance", "make_invoice", "lookup_invoice", "list_transactions", "get_info", "pay_offer", "make_offer", "lookup_offer", "list_offers", "disable_offer"], // list of supported methods for this connection
...
```jsonc
{
  ...
  "content": "pay_invoice pay_keysend get_balance get_info make_invoice lookup_invoice list_transactions pay_offer make_offer lookup_offer list_offers disable_offer multi_pay_invoice multi_pay_keysend sign_message notifications",
