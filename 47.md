...
```jsonc
{
    ...
    "result": {
            ...
            "methods": ["pay_invoice", "get_balance", "make_invoice", "lookup_invoice", "list_transactions", "get_info", "pay_offer", "make_offer", "lookup_offer", "pay_onchain", "make_new_address", "lookup_address", "subscribe_notifications"], // list of supported methods for this connection
...
```jsonc
{
  ...
  "content": "pay_invoice pay_keysend get_balance get_info make_invoice lookup_invoice list_transactions pay_offer make_offer lookup_offer pay_onchain make_new_address lookup_address subscribe_notifications sign_message notifications",
