...
```jsonc
{
    ...
    "content": "pay_invoice get_balance make_invoice lookup_invoice list_transactions get_info pay_bip321 make_bip321 notifications",
    // ...
}
```
...
```jsonc
{
    ...
    "result": {
            ...
            "methods": ["pay_invoice", "get_balance", "make_invoice", "lookup_invoice", "list_transactions", "get_info", "pay_bip321", "make_bip321"], // list of supported methods for this connection
...
```jsonc
{
  ...
  "content": "pay_invoice pay_keysend get_balance get_info make_invoice lookup_invoice list_transactions pay_bip321 make_bip321 multi_pay_invoice multi_pay_keysend sign_message notifications",
