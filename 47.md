...
```jsonc
{
    ...
    "params": {
        ...
        "amount": 50000, // amount in sats, required
...
```jsonc
{
    ...
    "result": {
        ...
        "total_received": 100000000, // total received in msats
        "transactions": [
            {
                "txid": "abc123...", // transaction ID
                "amount": 100000000, // amount in msats
...
```jsonc
{
    ...
    "result": {
        "balance": 10000, // user's total balance in msats
        "lightning_balance": 8000, // lightning balance in msats, optional
        "onchain_balance": 2000, // on-chain balance in msats, optional
    }
}
```
