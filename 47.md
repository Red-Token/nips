...
```jsonc
{
    ...
    "content": "pay_invoice get_balance make_invoice lookup_invoice list_transactions get_info estimate_onchain_fees pay_onchain make_new_address lookup_address list_addresses notifications",
    // ...
}
```
...
```jsonc
{
    ...
    "result": {
            ...
            "methods": ["pay_invoice", "get_balance", "make_invoice", "lookup_invoice", "list_transactions", "get_info", "estimate_onchain_fees", "pay_onchain", "make_new_address", "lookup_address", "list_addresses"], // list of supported methods for this connection
...
```jsonc
{
  ...
  "content": "pay_invoice pay_keysend get_balance get_info estimate_onchain_fees make_invoice lookup_invoice list_transactions pay_onchain make_new_address lookup_address list_addresses multi_pay_invoice multi_pay_keysend sign_message notifications",
